...
public class ListContacts extends BaseAdapter {
    Context context;
    public static List<Subject> subject_list;
    public ListContacts(List<Subject> listValue, Context context){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ViewItemContacts viewItem = null;
        if(convertView == null){
            viewItem = new ViewItemContacts();
            LayoutInflater layoutInflater = (LayoutInflater)this.context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);

            convertView = layoutInflater.inflate(R.layout.list_contacts, null);
            ...
            viewItem = (ViewItemContacts)convertView.getTag();
        }
...
class ViewItemContacts{
    TextView name, last, email, phone, age, education, join, out, software, goals;
